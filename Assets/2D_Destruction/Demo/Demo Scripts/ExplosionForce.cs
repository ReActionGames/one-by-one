...
public class ExplosionForce : MonoBehaviour {
    ...
    [SerializeField] private ForceMode2D forceType = ForceMode2D.Impulse;
    [SerializeField] private ForceMode2D torqueType = ForceMode2D.Impulse;
  ...
  //              AddExplosionForce(coll.GetComponent<Rigidbody2D>(), force, transform.position, radius, upliftModifer);
    ...
    private void AddExplosionForce(Rigidbody2D body, float explosionForce, Vector3 explosionPosition, float explosionRadius, float upliftModifier = 0)
	{
        ...
        baseForce.z = 0;
		body.AddForce(baseForce, forceType);
        body.AddTorque(torque, torqueType);
        ...
        if (upliftModifer != 0)
        {
            ...
            upliftForce.z = 0;
            body.AddForce(upliftForce, forceType);
        }
